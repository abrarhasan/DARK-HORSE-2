...
module.exports = {
  config: {
    ...
    category: "fun",
    guide: {
      en: "{pn} @mention or reply the one whom uh want me to hack"
    }
  },
  ...
  onStart: async function ({ event, message, usersData }) {
    try {
      ...
      await message.reply({
        body: "😎 Successfully hacked by ABRAR BOT! Check ur account settings",
      ...
      console.error(err);
      message.reply("❌ েSomething went wrong!");
    }
  }
};
