...
module.exports = {
	...
	onStart: async function({ event, api, args }) {
		...
		if (args[0] == "list") {
			...
			api.sendMessage("`________&&&&&&&________\n🚨Bot Connected successfully!🎯\n\nBot has been approved by Admin 🌻Abrar Hasan🌻.\n\n📚Hey dearies! This is 🌻ABRAR BOT🌻. Thank you for inviting me to the box!🥰\n\nIm always ready to assist you. Please let me know if I might help you anything! Enjoy with me.🥰😘\n\n▒▒░░░Bot Info░░░▒▒\n👉🏻Name:🌻💜𝕬𝖇𝖗𝖆𝖗'𝖘 𝕮𝖚𝖙𝖎𝖊💜🌻\n👉🏻Bot prefix: +\n👉🏻To view the list of commands, please enter: +help\n\n\n█▓▒▒Operator▒▒█▓\n🌻Abrar Hasan🌻\n👉🏻Age: 22🙈\n👉🏻Country: Bangladesh🇧🇩\n\n👉🏻For any help: https://www.facebook.com/abrar.hasan.125760550\n________&&&&&&&________", idBox, (error, info) => {
				if (error) {
